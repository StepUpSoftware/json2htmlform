...
(function() {
    ...
    var helpfunction = function() {
        ...
        console.log('  Example:');
        console.log('');
        console.log('    main.js inputfile ');
        console.log('');
        console.log('  e.g.');
        console.log('');
        console.log('    main.js "test.txt"');
        console.log('');
    };
        ...
        fs.readFile(cmd.args[0], 'utf8', function(err, data) {
            ...
            try {
                ...
                if (!json) {
                    ...
                    throw new Error("Source file does not contain valid JSON");
                ...
                if (msg.indexOf("SyntaxError") !== -1) {
                    ...
                    logger.log('input file does not look like JSON');
